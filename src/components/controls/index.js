...
function Controls({ itemCart = 0, uniqueItemsCount = 0, price = 0, onOpenCart }) {
  return (
    <div className="Controls">
      <div className="Controls-cart">
        В корзине: <span className="Controls-cart__bold">{itemCart === 0 ? 'пусто' : `${uniqueItemsCount} ${plural(uniqueItemsCount, {
